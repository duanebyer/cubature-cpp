...
static int cubature_v_base(unsigned fdim, integrand_v f, void *fdata, 
...
{
	return cubature_v_base(fdim, f, fdata, dim, xmin, xmax, 
		...
		double *val, double *err)
{
	...
	d.f = f; d.fdata = fdata;
	ret = cubature_v_base(fdim, fv, &d, dim, xmin, xmax, 
